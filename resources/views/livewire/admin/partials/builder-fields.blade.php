...
<div class="space-y-4 pb-20">
    ...
    <template x-for="(field, index) in fields" :key="field.id">
        <div
            class="bg-[#1a1a1a] p-5 rounded-xl border border-gray-800 shadow-md hover:border-l-4 hover:border-l-cyan-500 transition-all">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" @click="moveFieldUp(index)"
                                class="p-1 text-gray-500 hover:text-cyan-400 cursor-pointer"
                                :class="index === 0 ? 'opacity-30 !cursor-not-allowed' : ''" :disabled="index === 0"
                            ...
                            <button type="button" @click="moveFieldDown(index)"
                                class="p-1 text-gray-500 hover:text-cyan-400 cursor-pointer"
                                :class="index === fields.length - 1 ? 'opacity-30 !cursor-not-allowed' : ''"
                                :disabled="index === fields.length - 1" title="Pindah ke bawah">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <button type="button" @click="removeField(index)"
                                class="p-1 text-gray-500 hover:text-red-500 cursor-pointer" title="Hapus">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <textarea x-model="field.description" rows="2"
                ...
                <div class="space-y-3">
                    <div
                        ...
                        <span class="flex items-center gap-2">
                            <template x-if="field.type === 'note'"><span class="flex items-center gap-2"><svg
                                        class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 6h16M4 12h16M4 18h7" />
                                    </svg>Teks / Judul</span></template>
                            <template x-if="field.type === 'image-view'"><span class="flex items-center gap-2"><svg
                                        class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>Gambar Banner</span></template>
                            <template x-if="field.type === 'link'"><span class="flex items-center gap-2"><svg
                                        class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                                    </svg>Link Eksternal</span></template>
                        </span>
                        <button type="button" @click="removeField(index)"
                            class="text-gray-600 hover:text-red-500 cursor-pointer" title="Hapus">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg>
                    ...
                    <template x-if="field.type === 'note'">
                        <textarea x-model="field.description" rows="3"
                        ...
                        <div class="space-y-2" x-data="{ showFullscreen: false }">
                            <label
                                ...
                                <input type="file" accept="image/*" class="hidden"
                                    @change="handleBannerUpload($event, field)">
                            </label>
                            <template x-if="field.content">
                                <div class="relative w-fit group">
                                    <img :src="field.content"
                                        class="h-24 rounded border border-gray-700 object-cover cursor-pointer"
                                    ...
                                    <div
                                        ...
                                        <button type="button" @click="showFullscreen = true"
                                            class="p-1 bg-black/70 rounded text-white hover:bg-black transition cursor-pointer"
                                            title="Fullscreen">
                                        ...
                                        <a :href="field.content" target="_blank"
                                            class="p-1 bg-black/70 rounded text-white hover:bg-black transition cursor-pointer"
                                            title="Buka di tab baru" @click.stop>
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <button type="button" @click="field.content = ''"
                                        class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 cursor-pointer hover:bg-red-600 transition"
                                        title="Hapus gambar">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <template x-teleport="body">
                                        <div x-show="showFullscreen" x-cloak
                                            ...
                                            <div
                                                ...
                                                <a :href="field.content" target="_blank" @click.stop
                                                ...
                                                <button type="button" @click.stop="showFullscreen = false"
                        ...
                        <div class="space-y-4">
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="w-full md:w-40">
                                    <select x-model="field.type" @change="updateFieldType(index, field.type)"
                                        class="w-full bg-[#222] border border-gray-700 rounded p-2 text-sm text-gray-300 focus:border-cyan-500 outline-none">
                            ...
                            <div class="flex flex-col gap-3 bg-[#111] p-3 rounded border border-gray-800"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <button type="button" @click="toggleImage()"
                                        ...
                                        :class="imageUrl || showImage ? 'text-cyan-400 bg-cyan-900/30' :
                                    ...
                                    <button type="button" @click="toggleLink()"
                                        class="p-1 rounded transition cursor-pointer"
                                        :class="showLink ? 'text-cyan-400 bg-cyan-900/30' : 'text-gray-500 hover:text-white'"
                                        title="Sisipkan Link">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="space-y-3">
                                    <div x-show="showImage || imageUrl" x-cloak
                                        class="flex flex-col gap-2 animate-fade-in bg-black/30 p-2 rounded border border-gray-800">
                                        <div class="flex justify-between items-center">
                                            <label
                                                class="flex items-center gap-2 cursor-pointer bg-black border border-gray-700 rounded px-2 py-1 w-fit hover:border-cyan-500">
                                                <svg class="w-3 h-3 text-gray-400" x-show="!uploading" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                                                </svg>
                                                <svg class="w-3 h-3 text-cyan-400 animate-spin" x-show="uploading"
                                                ...
                                                <span class="text-[10px] text-gray-300"
                                                    x-text="uploading ? 'Uploading...' : 'Pilih Gambar'"></span>
                                                <input type="file" accept="image/*" class="hidden"
                                                    @change="handleImageUpload($event)">
                                            </label>
                                            <button type="button" @click="clearImageData()"
                                        ...
                                        <template x-if="imageUrl">
                                            <div class="relative w-fit group">
                                                <img :src="imageUrl"
                                                    class="h-24 rounded border border-gray-600 object-cover w-fit cursor-pointer"
                                                    alt="Preview" @click="showEmbedFullscreen = true">
                                                <div
                                                    class="absolute top-1 right-1 flex gap-1 opacity-0 group-hover:opacity-100 transition">
                                                    <button type="button" @click="showEmbedFullscreen = true"
                                                        class="p-1 bg-black/70 rounded text-white hover:bg-black transition cursor-pointer"
                                                        title="Fullscreen">
                                                        <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                ...
                                                <template x-teleport="body">
                                                    <div x-show="showEmbedFullscreen" x-cloak
                                                        x-transition:enter="transition ease-out duration-200"
                                                        ...
                                                        @click="showEmbedFullscreen = false"
                                                        @keydown.escape.window="showEmbedFullscreen = false"
                                                        class="fixed inset-0 z-[99999] bg-black flex items-center justify-center p-4 cursor-pointer">
                                                        <div
                                                            class="absolute top-4 left-1/2 -translate-x-1/2 flex gap-2 bg-black/80 backdrop-blur-sm px-3 py-2 rounded-full border border-gray-700">
                                                            ...
                                                            <button type="button"
                                                                @click.stop="showEmbedFullscreen = false"
                                                                class="p-2 text-white hover:text-red-400 transition cursor-pointer"
                                                                title="Tutup (ESC)">
                                                                <svg class="w-5 h-5" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div x-show="showLink" x-cloak
                                        class="flex gap-2 animate-fade-in bg-black/30 p-2 rounded border border-gray-800 items-center">
                                        <div class="flex-1 flex flex-col gap-2">
                                            <input type="text" x-model="field.linkUrl"
                                            ...
                                            <input type="text" x-model="field.linkText"
                                                class="bg-black text-xs text-white border border-gray-700 rounded px-2 py-1 outline-none focus:border-cyan-500"
                                                placeholder="Teks Link (Optional)">
                                        </div>
                                        <button type="button" @click="clearLinkData()"
                                            class="text-gray-600 hover:text-red-500 cursor-pointer p-1"
                                            title="Hapus link">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                            ...
                            <template x-if="field.type === 'file'">
                                <div class="ml-2 mt-4 space-y-4 border-l-2 border-cyan-500 pl-4 bg-cyan-900/10 p-4 rounded-r-lg"
                                    x-data="fileSettings(field)">
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-300">Batasi jenis file</span>
                                        <button type="button" @click="toggleRestrict()"
                                            class="relative inline-flex h-5 w-10 items-center rounded-full transition cursor-pointer"
                                            :class="restrictTypes ? 'bg-cyan-600' : 'bg-gray-600'">
                                            <span
                                                class="inline-block h-3 w-3 transform rounded-full bg-white transition"
                                                :class="restrictTypes ? 'translate-x-6' : 'translate-x-1'"></span>
                                        </button>
                                    </div>
                                    <div x-show="restrictTypes" x-cloak class="grid grid-cols-2 gap-3">
                                        <template x-for="ft in fileTypeOptions" :key="ft.id">
                                            <label
                                                ...
                                                <input type="checkbox" @click="toggleType(ft.id)"
                                                    :checked="allowedTypes.includes(ft.id)"
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <select x-model="field.fileSettings.maxSize"
                                            class="bg-black border border-gray-700 rounded p-1 text-sm text-white">
                                    ...
                                    <template x-for="(option, optIndex) in field.options" :key="optIndex">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button type="button" @click="removeOption(index, optIndex)"
                                                ...
                                                title="Hapus opsi"><svg class="w-4 h-4" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                                </svg></button>
                            ...
                            <div class="flex justify-between items-center gap-4 pt-4 border-t border-gray-800 mt-4">
                                <div class="flex items-center gap-1">
                                    <button type="button" @click="moveFieldUp(index)"
                                        ...
                                        :class="index === 0 ? 'text-gray-700 !cursor-not-allowed' :
                                    ...
                                    <button type="button" @click="moveFieldDown(index)"
                                        class="p-1.5 rounded transition cursor-pointer"
                                        :class="index === fields.length - 1 ? 'text-gray-700 !cursor-not-allowed' :
                                            'text-gray-500 hover:text-cyan-400 hover:bg-cyan-900/20'"
                                        :disabled="index === fields.length - 1" title="Pindah ke bawah">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-2 border-r border-gray-700 pr-4">
                                        <span class="text-xs text-gray-500 cursor-pointer"
                                            @click="toggleRequired(field)">Wajib</span>
                                        <button type="button" @click="toggleRequired(field)"
                                            class="w-8 h-4 rounded-full cursor-pointer relative transition"
                                            :class="field.required ? 'bg-cyan-600' : 'bg-gray-700'">
                                            <div class="w-2 h-2 bg-white rounded-full absolute top-1 transition-all"
                                                :class="field.required ? 'left-5' : 'left-1'"></div>
                                        </button>
                                    </div>
                                    <button type="button" @click="duplicateField(index)"
                                        class="text-gray-500 hover:text-white p-2 cursor-pointer"
                                        title="Duplikasi"><svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                        </svg></button>
                                    <button type="button" @click="removeField(index)"
                                        class="text-gray-500 hover:text-red-500 p-2 cursor-pointer"
